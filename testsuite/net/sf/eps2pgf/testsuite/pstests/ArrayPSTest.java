...
public class ArrayPSTest {
    ...
    /** Test. @throws Exception the exception */
    @Test
    public void getinterval4() throws Exception {
    ...
    /** Test. @throws Exception the exception */
    @Test
    public void putinterval3() throws Exception {
    ...
    /** Test. @throws Exception the exception */
    @Test
    public void astore1() throws Exception {
    ...
    /** Test. @throws Exception the exception */
    @Test
    public void aload1() throws Exception {
    ...
    /** Test. @throws Exception the exception */
    @Test
    public void aload2() throws Exception {
        String cmd = "{23 (ab) -1} aload type /arraytype eq 4 1 roll -1 eq"
            + " 4 1 roll (ab) eq 4 1 roll 23 eq";
        assertTrue(Common.testString(interp, cmd, 4));
    }
