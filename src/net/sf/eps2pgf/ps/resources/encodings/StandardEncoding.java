...
public final class StandardEncoding {
    ...
    public static PSObjectName[] get() {
        ...
        vector[0240] = EncodingManager.SYMB_NOTDEF;      //240
        ...
        vector[0260] = EncodingManager.SYMB_NOTDEF;      //260
        ...
        vector[0265] = EncodingManager.SYMB_NOTDEF;      //265
        ...
        vector[0276] = EncodingManager.SYMB_NOTDEF;      //276        
        vector[0277] = new PSObjectName("/questiondown"); //277
        vector[0300] = EncodingManager.SYMB_NOTDEF;      //300
        ...
        vector[0311] = EncodingManager.SYMB_NOTDEF;      //311
        vector[0312] = new PSObjectName("/ring");        //312
        vector[0313] = new PSObjectName("/cedilla");     //313
        vector[0314] = EncodingManager.SYMB_NOTDEF;      //314
        ...
        vector[0321] = EncodingManager.SYMB_NOTDEF;      //321
        vector[0322] = EncodingManager.SYMB_NOTDEF;      //322
        vector[0323] = EncodingManager.SYMB_NOTDEF;      //323
        vector[0324] = EncodingManager.SYMB_NOTDEF;      //324
        vector[0325] = EncodingManager.SYMB_NOTDEF;      //325
        vector[0326] = EncodingManager.SYMB_NOTDEF;      //326
        vector[0327] = EncodingManager.SYMB_NOTDEF;      //327
        vector[0330] = EncodingManager.SYMB_NOTDEF;      //330
        vector[0331] = EncodingManager.SYMB_NOTDEF;      //331
        vector[0332] = EncodingManager.SYMB_NOTDEF;      //332
        vector[0333] = EncodingManager.SYMB_NOTDEF;      //333
        vector[0334] = EncodingManager.SYMB_NOTDEF;      //334
        vector[0335] = EncodingManager.SYMB_NOTDEF;      //335
        vector[0336] = EncodingManager.SYMB_NOTDEF;      //336
        vector[0337] = EncodingManager.SYMB_NOTDEF;      //337
        vector[0340] = EncodingManager.SYMB_NOTDEF;      //340
        vector[0341] = new PSObjectName("/AE");          //341
        vector[0342] = EncodingManager.SYMB_NOTDEF;      //342
        vector[0343] = new PSObjectName("/ordfeminine"); //343
        vector[0344] = EncodingManager.SYMB_NOTDEF;      //344
        vector[0345] = EncodingManager.SYMB_NOTDEF;      //345
        vector[0346] = EncodingManager.SYMB_NOTDEF;      //346
        vector[0347] = EncodingManager.SYMB_NOTDEF;      //347
        ...
        vector[0354] = EncodingManager.SYMB_NOTDEF;      //354
        vector[0355] = EncodingManager.SYMB_NOTDEF;      //355
        vector[0356] = EncodingManager.SYMB_NOTDEF;      //356
        vector[0357] = EncodingManager.SYMB_NOTDEF;      //357
        vector[0360] = EncodingManager.SYMB_NOTDEF;      //360
        vector[0361] = new PSObjectName("/ae");          //361
        vector[0362] = EncodingManager.SYMB_NOTDEF;      //362
        vector[0363] = EncodingManager.SYMB_NOTDEF;      //363
        vector[0364] = EncodingManager.SYMB_NOTDEF;      //364
        vector[0365] = new PSObjectName("/dotlessi");    //365
        vector[0366] = EncodingManager.SYMB_NOTDEF;      //366
        vector[0367] = EncodingManager.SYMB_NOTDEF;      //367
        ...
        vector[0374] = EncodingManager.SYMB_NOTDEF;      //374
        vector[0375] = EncodingManager.SYMB_NOTDEF;      //375
        vector[0376] = EncodingManager.SYMB_NOTDEF;      //376
